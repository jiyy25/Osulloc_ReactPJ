            ...
            <div className='dada container pb-5'>
                ...
                <div className='dadaBox border mt-4'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='dadaform mx-auto'>
                        <div className='m-2'>
                            <input type="text" name='userName'{...register("userName", { required: true })} placeholder='이름' className='border w-100 p-2' />
                            {errors.userName && <p>이름을 입력하세요</p>}
                        </div>
                        <div className='m-2'>
                            <input type="text" name='phone'{...register("phone", { required: true })} placeholder='전화번호' className='border w-100 p-2' />
                            {errors.phone && <p>전화번호를 입력하세요</p>}
                        </div>
                        <div className='m-2'>
                            <input type="email" name='userEmail'{...register("userEmail", { required: true })} placeholder='메일주소' className='border w-100 p-2' />
                            {errors.userEmail && <p>메일주소를 입력하세요</p>}
                        </div>
                        <div className='m-2'>
                            <textarea type="text" name='board'{...register("board", { required: false })} placeholder='문의사항' className='border w-100 p-2' />
                        </div>
